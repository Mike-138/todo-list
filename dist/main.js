...
const renderBody = (elements) => {
    ...
    document.body.replaceChildren(_modules_modals_project_modal__WEBPACK_IMPORTED_MODULE_5__["default"].getHtml(), addProjectButton, ...stack);
}
...
addProjectButton.addEventListener("click", () => {
    _modules_modals_project_modal__WEBPACK_IMPORTED_MODULE_5__["default"].getHtml().showModal();
})

_modules_modals_project_modal__WEBPACK_IMPORTED_MODULE_5__["default"].getHtml().addEventListener("submit", () => {
    const createProject = () => {
