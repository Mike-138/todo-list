...
.notes::before {
    content: "Notes:";
    display: block;
}`, "",{"version":3,"sources":["webpack://./src/styles/style.css"],"names":[],"mappings":"AAAA;IACI,sBAAsB;AAC1B;;AAEA;IACI,SAAS;IACT,UAAU;IACV,mBAAmB;AACvB;;AAEA;IACI,kBAAkB;IAClB,gDAAgD;IAChD,aAAa;IACb,iBAAiB;IACjB,aAAa;IACb,SAAS;IACT,2BAA2B;AAC/B;;AAEA;IACI,eAAe;IACf,SAAS;IACT,WAAW;IACX,YAAY;IACZ,WAAW;IACX,4BAA4B;IAC5B,YAAY;IACZ,aAAa,EAAE,mEAAmE;IAClF,2CAA2C;IAC3C,kBAAkB;IAClB,qBAAqB;IACrB,gBAAgB,EAAE,qEAAqE;AAC3F;;AAEA;IACI,qBAAqB;AACzB;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI,aAAa;IACb,aAAa;IACb,WAAW;IACX,sBAAsB;IACtB,mBAAmB;IACnB,2CAA2C;AAC/C;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI;AACJ;;AAEA;IACI,iBAAiB;IACjB,cAAc;AAClB","sourcesContent":["html {\n    box-sizing: border-box;\n}\n\n*, *::before, *::after {\n    margin: 0;\n    padding: 0;\n    box-sizing: inherit;\n}\n\nbody {\n    position: relative;\n    font-family: Verdana, Geneva, Tahoma, sans-serif;\n    padding: 1rem;\n    min-height: 100vh;\n    display: grid;\n    gap: 1rem;\n    grid-auto-rows: min-content;\n}\n\n.add-project-button {\n    position: fixed;\n    top: 4rem;\n    right: 5rem;\n    height: 5rem;\n    width: 5rem;\n    background-color: aquamarine;\n    border: none;\n    outline: none; /* Set to none to make button only clickable within border radius */\n    box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;\n    border-radius: 50%;\n    transition: all 100ms;\n    overflow: hidden; /* Prevents content in button from overflowing beyond border radius */\n}\n\n.add-project-button:hover {\n    transform: scale(1.1);\n}\n\n.add-project-button > img {\n    border-radius: 50%;\n}\n\n.project {\n    padding: 1rem;\n    display: grid;\n    gap: 0.5rem;\n    background-color: gray;\n    border-radius: 10px;\n    box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;\n}\n\n.project > *:empty {\n    display: none;\n}\n\n.due::before {\n    content: \"Due: \";\n}\n\n.priority::before {\n    content: \"Priority: \"\n}\n\n.notes::before {\n    content: \"Notes:\";\n    display: block;\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
