...
`, "",{"version":3,"sources":["webpack://./src/styles/modal.css"],"names":[],"mappings":"AAAA;EACE,wBAAwB;EACxB,0BAA0B;EAC1B,yBAAyB;EACzB,uBAAuB;EACvB,qBAAqB;AACvB;;AAEA;EACE,eAAe;EACf,yBAAyB;EACzB,kBAAkB;EAClB,QAAQ;EACR,SAAS;EACT,wBAAwB;EACxB,iCAAiC;EACjC,YAAY;EACZ,mBAAmB;EACnB,2CAA2C;EAC3C,gCAAgC;EAChC,qBAAqB;AACvB;;AAEA;EACE;IACE,2CAA2C;EAC7C;EACA;IACE,yCAAyC;EAC3C;AACF;;AAEA,6DAA6D;AAC7D;EACE,YAAY;EACZ,wBAAwB;EACxB,yCAAyC;EACzC,QAAQ;AACV;;AAEA;;;EAGE,eAAe;EACf,sBAAsB;EACtB,wBAAwB;EACxB,wCAAwC;EACxC,YAAY;EACZ,aAAa;EACb,kBAAkB;AACpB;;AAEA;EACE,WAAW;AACb;;AAEA;EACE,yBAAyB;EACzB,YAAY;EACZ,aAAa;EACb,kBAAkB;AACpB;;AAEA;EACE,yBAAyB;EACzB,YAAY;EACZ,aAAa;EACb,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,WAAW;AACb;;AAEA;EACE,gBAAgB;EAChB,qBAAqB;EACrB,mBAAmB;AACrB;;AAEA;;EAEE,iBAAiB;AACnB;;AAEA;EACE,mBAAmB;AACrB;;AAEA;EACE,oBAAoB;AACtB","sourcesContent":[":root {\n  --primary-color: #35495e;\n  --secondary-color: #347474;\n  --tertiary-color: #42b883;\n  --widget-color: #ff7e67;\n  --font-color: #fcfefe;\n}\n\ndialog {\n  font-size: 1rem;\n  text-transform: uppercase;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  color: var(--font-color);\n  background: var(--tertiary-color);\n  border: none;\n  border-radius: 10px;\n  box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;\n  transform: translate(-50%, -50%);\n  animation: grow 200ms;\n}\n\n@keyframes grow {\n  from {\n    transform: translate(-50%, -50%) scale(0.9);\n  }\n  to {\n    transform: translate(-50%, -50%) scale(1);\n  }\n}\n\n/* The modal form is designed to be a dynamic 2 column grid */\nform[method=\"dialog\"] {\n  padding: 2em;\n  display: grid !important;\n  grid-template-columns: 1fr 1fr !important;\n  gap: 2em;\n}\n\ninput,\nselect,\ntextarea {\n  padding: 0.25em;\n  letter-spacing: 0.05em;\n  color: var(--font-color);\n  background-color: var(--secondary-color);\n  border: none;\n  outline: none;\n  border-radius: 5px;\n}\n\nform[method=\"dialog\"] > button > img {\n  height: 5em;\n}\n\nform[method=\"dialog\"] > button:first-of-type {\n  background-color: #f95959;\n  border: none;\n  outline: none;\n  border-radius: 5px;\n}\n\nform[method=\"dialog\"] > button:last-of-type {\n  background-color: #a1dd70;\n  border: none;\n  outline: none;\n  border-radius: 5px;\n}\n\n.field-container {\n  display: grid;\n  gap: 0.25em;\n}\n\n.field-container > label {\n  font-size: 0.9em;\n  letter-spacing: 0.1em;\n  padding-left: 0.5em;\n}\n\n.field-container > input,\n.field-container > select {\n  font-size: 1.25em;\n}\n\n.wide {\n  grid-column: span 2;\n}\n\n.wide.center {\n  justify-self: center;\n}\n"],"sourceRoot":""}]);
;EAClB,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,UAAU;EACV,WAAW;EACX,iBAAiB;AACnB;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,mBAAmB;AACrB","sourcesContent":[":root {\n  --primary-color: #35495e;\n  --secondary-color: #347474;\n  --tertiary-color: #42b883;\n  --widget-color: #ff7e67;\n  --font-color: #fcfefe;\n  --background-gradient: linear-gradient(rgb(182, 244, 146), rgb(51, 139, 147));\n}\n\nhtml {\n  box-sizing: border-box;\n}\n\n*,\n*::before,\n*::after {\n  margin: 0;\n  padding: 0;\n  box-sizing: inherit;\n}\n\nbody {\n  position: relative;\n  font-family: Verdana, Geneva, Tahoma, sans-serif;\n  padding: 1rem;\n  min-height: 100vh;\n  display: grid;\n  gap: 1rem;\n  grid-auto-rows: min-content;\n  background: var(--background-gradient);\n}\n\n.add-project-button {\n  position: fixed;\n  top: 4rem;\n  right: 5rem;\n  width: 5rem;\n  background: var(--tertiary-color);\n  border: none;\n  outline: none; /* Set to none to make button only clickable within border radius */\n  box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;\n  border-radius: 50%;\n  transition: all 100ms;\n  overflow: hidden; /* Prevents content in button from overflowing beyond border radius */\n}\n\n.add-project-button:hover,\n.add-todo-button:hover {\n  transform: scale(1.1);\n}\n\n.add-project-button > img,\n.add-project-button > img {\n  display: block;\n}\n\n.add-todo-button {\n  width: 5rem;\n  background: var(--widget-color);\n  border: none;\n  outline: none; /* Set to none to make button only clickable within border radius */\n  box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;\n  border-radius: 50%;\n  transition: all 100ms;\n  overflow: hidden; /* Prevents content in button from overflowing beyond border radius */\n}\n\n.project {\n  font-size: 1rem;\n  letter-spacing: 0.1em;\n  padding: 1rem;\n  display: grid;\n  grid-template-rows: min-content;\n  gap: 1.5rem;\n  color: var(--font-color);\n  background: var(--primary-color);\n  border-radius: 10px;\n  box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;\n}\n\n.todo-container {\n  display: grid;\n  grid-template-rows: min-content;\n  gap: 1rem;\n}\n\n.hidden {\n  display: none;\n}\n\n.project-content {\n  width: calc(\n    100% - 12rem\n  ); /* 12rem = width of add project button (5rem) + 2 * button distance from edge (10rem) - padding (2rem) - 1rem (look and feel) */\n  display: grid;\n  gap: 1rem;\n  border-right: 0.25rem solid var(--secondary-color);\n}\n\n.project-content > *:empty::after {\n  content: \"None\";\n  color: gray;\n}\n\n.add-todo-button {\n  height: 5rem;\n  width: 5rem;\n}\n\n.description {\n  font-weight: normal;\n}\n\n.description::before {\n  content: \"Description\";\n  padding-left: 0.5em;\n  font-size: 0.5em;\n  font-weight: initial;\n  display: block;\n  text-transform: uppercase;\n}\n\n.due,\n.priority,\n.status {\n  text-transform: uppercase;\n}\n\n.due::before {\n  content: \"Due\";\n  padding-left: 0.5em;\n  font-size: 0.75em;\n  font-weight: initial;\n  display: block;\n  text-transform: uppercase;\n}\n\n.priority::after {\n  content: \" Priority\";\n  text-transform: uppercase;\n}\n\n.project:has(.priority.low){\n  color: black;\n  background-color: #cbf078;\n}\n\n.project:has(.priority.medium) {\n  color: black;\n  background-color: #f8f398;\n}\n\n.project:has(.priority.high) {\n  background-color: #f1b963;\n}\n\n.project:has(.priority.urgent) {\n  background-color: #e46161;\n}\n\n.notes::before {\n  content: \"Notes\";\n  padding-left: 0.5em;\n  font-size: 0.75em;\n  display: block;\n  text-transform: uppercase;\n}\n\n.task {\n  font-size: 1rem;\n  letter-spacing: 0.1em;\n  padding: 1rem 2rem;\n  color: var(--font-color);\n  background: var(--secondary-color);\n  border-radius: 10px;\n  box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;\n}\n\n.task-content {\n  display: flex;\n  gap: 5rem;\n  align-items: center;\n}\n\n.task-content > .title {\n  font-size: 2em;\n  font-weight: bold;\n  margin-right: auto;\n  display: flex;\n  align-items: center;\n}\n\ninput[type=\"checkbox\"] {\n  width: 2em;\n  height: 2em;\n  margin-right: 1em;\n}\n\n.task-content > *:empty {\n  display: none;\n}\n\n.field-container:has(#todoTitle) {\n  grid-column: span 2;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (buttonFactory);
...
/* harmony import */ var _assets_icons_check_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../assets/icons/check.svg */ "./src/assets/icons/check.svg");
/* harmony import */ var _assets_icons_close_svg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../assets/icons/close.svg */ "./src/assets/icons/close.svg");
...
const modalFactory = (modalId) => {
  ...
  const _cancelButton = (() => {
    ...
    const image = document.createElement("img");
    image.src = _assets_icons_close_svg__WEBPACK_IMPORTED_MODULE_2__;
  ...
  const _confirmButton = (() => {
    ...
    const image = document.createElement("img");
    image.src = _assets_icons_check_svg__WEBPACK_IMPORTED_MODULE_1__;
    button.appendChild(image);
    return button;
  })();
  ...
  const build = () => {
    for (const header of _formHeaders) {
      _modalForm.appendChild(header);
    }

    for (const field of _formFields) {
      const packagedField = _packageField(field);
...
const project = (title, description, dueDate, priority, notes, ...items) => {
  ...
  const getFormattedDueDate = () => {
    ...
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(year, month, day), "PPP");
  };
  ...
  const createCard = () => {
    ...
    innerContainer.append(title, description, dueDate, priority, notes);
...
/* harmony import */ var _modules_button_factory__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/button_factory */ "./src/modules/button_factory.js");
...
const projectModalHtml = _modules_modals_project_modal__WEBPACK_IMPORTED_MODULE_5__["default"].getHtml();
const projectModalInfo = _modules_modals_project_modal__WEBPACK_IMPORTED_MODULE_5__["default"].getInfo();
const todoModalHtml = _modules_modals_todo_modal__WEBPACK_IMPORTED_MODULE_4__["default"].getHtml();
const todoModalInfo = _modules_modals_todo_modal__WEBPACK_IMPORTED_MODULE_4__["default"].getInfo();
...
const projectButton = (0,_modules_button_factory__WEBPACK_IMPORTED_MODULE_6__["default"])().addContentImage(_assets_icons_plus_svg__WEBPACK_IMPORTED_MODULE_1__).build();
...
projectModalHtml.addEventListener("submit", () => {
  const newProject = (0,_modules_project_object__WEBPACK_IMPORTED_MODULE_3__["default"])().fromObject(projectModalInfo);
  const newProjectCard = newProject.createCard();
  bodyElements.push(newProjectCard);

  const taskButton = (0,_modules_button_factory__WEBPACK_IMPORTED_MODULE_6__["default"])().addContentImage(_assets_icons_plus_svg__WEBPACK_IMPORTED_MODULE_1__).build();
...
todoModalHtml.addEventListener("submit", () => {
  const newTodo = (0,_modules_todo_object__WEBPACK_IMPORTED_MODULE_2__["default"])().fromObject(todoModalInfo);
